			...
			<Container>
				<div className='relative mx-auto max-w-2xl pt-36'>
					<div className='mx-auto text-center lg:w-2/3'>
						<h1 className='text-5xl font-bold text-gray-900 dark:text-white md:text-6xl xl:text-7xl'>Privacy Policy</h1>
					</div>
					<div className='mt-8 text-gray-700 dark:text-gray-300'>
						...
						<br />
						<p className='font-bold text-primary dark:text-white'>Information We Collect:</p>
						...
						<br />
						<p className='font-bold text-primary dark:text-white'>How We Use Your Information:</p>
						<ul className='list-disc'>
						...
						<br />
						<p className='font-bold text-primary dark:text-white'>Your Choices:</p>
						<ul className='list-disc'>
							<li>You can access and update your personal information in your account settings.</li>
							<li>You can delete your account at any time.</li>
						</ul>{' '}
						<br />
						<p className='font-bold text-primary dark:text-white'>Children&apos;s Privacy:</p>
						<ul className='list-disc'>
						...
						<br />
						<p className='font-bold text-primary dark:text-white'>Contact Us:</p>
						<ul className='list-disc'>
							<li>
