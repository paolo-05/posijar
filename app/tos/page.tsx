					...
					<div className='mt-8 text-gray-700 dark:text-gray-300'>
						...
						<ol className='list-decimal'>
							...
							<li>
								...
								terms, please{' '}
								<Link href='mailto:paolo.bianchessi@icloud.com' className='underline transition hover:text-primary'>
									contact us
								</Link>
								.
							</li>
						...
						<br />
						<h2 className='text-xl font-semibold text-gray-700 dark:text-white'>Thank you for using PosiJar!</h2>
					</div>
				</div>
			</Container>
		</main>
