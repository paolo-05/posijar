        ...
        <div className="relative mx-auto max-w-2xl pt-36">
          ...
          <div className="mt-8 text-gray-700 dark:text-gray-300">
            ...
            <p className="mt-2 italic text-gray-500 dark:text-gray-400">
              ...
              by the following terms and conditions of use. If you disagree with
            ...
            <ol className="list-decimal">
              <li>
                ...
                - You must be at least 13 years old to use this service. - You
              ...
              <li>
                ...
                PosiJar reserves the right to remove any content that violates
                these terms.
              </li>
              <li>
                <span className="font-bold text-primary dark:text-white">
                ...
                - Your use of PosiJar is also governed by our Privacy Policy.{' '}
              </li>
              <li>
                <span className="font-bold text-primary dark:text-white">
                  Modifications:
              ...
              <li>
                ...
                - PosiJar is provided &qout;as is&quot; without any warranties.{' '}
              </li>
              <li>
                <span className="font-bold text-primary dark:text-white">
                  Governing Law:
