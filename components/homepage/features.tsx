...
const features = [
  ...
  },
  {
    ...
    icon: 'https://cdn-icons-png.flaticon.com/512/6976/6976288.png',
  },
];
          ...
          {features.map((feature) => (
            ...
            >
              <div className="grid grid-cols-1 gap-4 p-8 py-12">
                ...
                />
                <h5 className="text-xl font-semibold text-gray-700 transition group-hover:text-brandSecondary dark:text-white">
                  {feature.title}
                </h5>
                <p className="text-gray-600 dark:text-gray-300">
                  {feature.description}
