						...
						<div className='relative'>
							<div className='flex items-center justify-center -space-x-2'>
								<div className='bg-white p-8 rounded-md shadow-md max-w-md w-full dark:bg-gray-800 dark:text-white'>
									...
									<div className='mb-4'>
										<p className='text-gray-600 dark:text-gray-200'>Username: {session?.user.name}</p>
										<p className='text-gray-600 dark:text-gray-200'>Email: {session?.user.email}</p>
									</div>
									<button
									...
									>
										<span className='relative text-sm font-semibold text-white'>Delete My Account</span>
									</button>
								</div>
							</div>
							{showAlert && (
