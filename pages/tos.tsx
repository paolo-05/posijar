						...
						<div className='relative pt-36 max-w-2xl mx-auto'>
							...
							<div className='mt-8 text-gray-700 dark:text-gray-300'>
								...
								<ol className='list-decimal'>
									<li>
										<span className='text-primary dark:text-white font-bold'>Use of the Service:</span> - You must be at
										least 13 years old to use this service. - You are responsible for maintaining the security of your
										account and password.
									</li>
									<li>
										<span className='text-primary dark:text-white font-bold'>User Content:</span> - Users are solely
										responsible for the content they submit. - PosiJar reserves the right to remove any content that
										violates these terms.
									</li>
									<li>
										<span className='text-primary dark:text-white font-bold'>Privacy:</span> - Your use of PosiJar is
										also governed by our Privacy Policy.{' '}
									</li>
									<li>
										<span className='text-primary dark:text-white font-bold'>Modifications:</span> - PosiJar reserves
										the right to modify or discontinue the service without notice.
									</li>
									<li>
										{' '}
										<span className='text-primary dark:text-white font-bold'>Disclaimer:</span> - PosiJar is provided
										&qout;as is&quot; without any warranties.{' '}
									</li>
									<li>
										<span className='text-primary dark:text-white font-bold'>Governing Law:</span> - These terms are
									...
									<li>
										<span className='text-primary dark:text-white font-bold'>Contact:</span> - For questions about these
										terms, please{' '}
